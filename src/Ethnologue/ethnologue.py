...
class ethnologue(): 
    data = json.load(open("etho.json","r",encoding="utf-8"))  
    #@staticmethod
    def country_list():
         """
    ...
    def country_summary(country_name="India"):
        ...
        Examples
        --------        
        >>> ethnologue.country_summary('Sri_Lanka')
        ...
        >>> ethnologue.country_summary('China')
        ...
        """
         return(ethnologue.data[country_name]['summary'])
    ...
    def country_officialname(country_name="India"):
        ...
        Examples
        --------
        >>> ethnologue.country_officialname('Thailand')
        'Kingdom of Thailand'

        >>> ethnologue.country_officialname('Algeria')
        'Democratic and Popular Republic of Algeria'
        
        """
         return(ethnologue.data[country_name]['official_name'])
    ...
    def country_code(country_name="IN"):
        ...
        Examples:
        --------
        >>> ethnologue.country_code("Algeria")
        DZ

        >>> ethnologue.country_code("Japan")
        JP
        """
         return(ethnologue.data[country_name]['country_code(ISO3166)'])
    ...
    def country_area(country_name="India"):
        ...
        Examples:
        --------
        >>> ethnologue.country_area("Bangladesh")
        '130170 Square Kilometer'

        >>> ethnologue.country_area("Argentina")
        '2736690 Square Kilometer'
        """
         return(str(ethnologue.data[country_name]['area(sq_km)'])+" Square Kilometer")
    ...
    def country_commencement(country_name="India"):
        ...
        Examples:
        --------
        >>> ethnologue.country_commencement('Pakistan')
        1947

        >>> ethnologue.country_commencement('Japan')
        1956

        >>> ethnologue.country_commencement('Mexico')
        1945
        """
         return(ethnologue.data[country_name]['commencement'])
    ...
    def country_continent(country_name="India"):
        ...
        Examples:
        --------
        >>>  ethnologue.country_continent('Sri_Lanka')
        'Asia'

        >>> ethnologue.country_continent('New_Zealand')
        'Australia'

        """
         return(ethnologue.data[country_name]['continent'])
    ...
    def country_families(country_name="India"):
        ...
        Examples:
        --------
        >>> ethnologue.country_families('China')
        ...
        >>> ethnologue.country_families('Thailand')
        dict_keys(['Austro-Asiatic', 'Kra-Dai', 'Sino-Tibetan', 'Austronesian', 'Sign language', 'Hmong-Mien'])
        """

         return(ethnologue.data[country_name]['families'].keys())
    ...
    def country_vitality(country_name="India"):
        ...
        Examples:
        --------
        >>> ethnologue.country_vitality("Mexico")
         ['Institutional', '0', 'Stable', '155', 'Endangered', '129', 'Extinct', '13']

        >>> ethnologue.country_vitality("Switzerland")
        ['Institutional', '3', 'Stable', '5', 'Endangered', '2', 'Extinct', '0']

        >>> ethnologue.country_vitality("Thailand")
        ['Institutional', '3', 'Stable', '25', 'Endangered', '23', 'Extinct', '0']

        """
         return(ethnologue.data[country_name]['vitality'])
    ...
    def continent_countries(continent="Asia"):
        ...
        Examples:
        --------
        >>> ethnologue.continent_countries('Australia')
        ...
        >>>  ethnologue.continent_countries('Africa')
        ...
        """
         conti=[]
         for i in ethnologue.data.keys():
             if(ethnologue.data[i]['continent'] == continent):
                 conti.append(i)
         return(conti)
    ...
    def total_countries():
        ...
        Examples:
        --------
        >>> ethnologue.total_countries()
        195 

        """
         print(len(ethnologue.data.keys()))
    ...
    def continent_length(continent="Asia"):
        ...
        Examples:
        --------
        >>> ethnologue.continent_length("Africa")
        53

        >>> ethnologue.continent_length("Australia")
        15
    ...
    def country_languages(country_name="India"):
        ...
        Examples:
        --------
        >>> ethnologue.country_languages('Namibia')
        ...
        'Zemba']
         ...
         >>> ethnologue.country_languages('Japan')
        ...
        x = []
        for i in ethnologue.data[country_name]['languages']:
            x.append(i)
        return x
    ...
    def language_summary( country_name="India", lang="Tamil"):
        ...
        Examples:
        --------
        >>> ethnologue.language_summary('India','Tamil')
        ...
        >>> ethnologue.language_summary('Namibia','Fwe')
        ...
        """
        return (ethnologue.data[country_name]['languages'][lang]['summary'])
    ...
    def language_code(country_name="India", lang="Tamil"):
        ...
        Examples:
        --------
        >>> ethnologue.language_code('India','Tamil')
        'tam'

        >>> ethnologue.language_code('Argentina','Lule')
        'ule'
        """
        return (ethnologue.data[country_name]['languages'][lang]['language_code(ISO639)'])
    ...
    def language_population(country_name="India", lang="Tamil"):
        ...
        Examples:
        --------
        >>> ethnologue.language_population('India','Tamil')
        '1M to 1B'

        >>> ethnologue.language_population('Mexico','Yaqui')
        '10K to 1M'
        """
        return (ethnologue.data[country_name]['languages'][lang]['population'])
    ...
    def language_family(country_name="India", lang="Tamil"):
        ...
        Examples:
        --------
        >>> ethnologue.language_family('India','Tamil')
        'It belongs to the Dravidian language family.'

        >>> ethnologue.language_family('China','Zhaba')
        'It belongs to the Sino-Tibetan language family.'

        >>> ethnologue.language_family('Mexico','Yaqui')
        'It belongs to the Uto-Aztecan language family.'
        """
        return (ethnologue.data[country_name]['languages'][lang]['family'])
    ...
    def lang_to_country(lang="Tamil"):
        ...
        Examples:
        --------
        >>> ethnologue.lang_to_country('Tamil')
        India
        Sri_Lanka

        >>> ethnologue.lang_to_country('Spanish')
        Andorra
        Spain
        """
        ...
        for i in ethnologue.data.keys():
            a=[]
            for j in ethnologue.data[i]['languages'].keys():
                a.append(j)
            for k in a:
    ...
    def languagecode_to_country(code):
        ...
        Examples:
        --------
        >>> ethnologue.languagecode_to_country('eng')
        Ireland
        United_Kingdom
        
        >>> ethnologue.languagecode_to_country('spa')
        Andorra
        Spain
        """
        for i in ethnologue.data.keys():
            for j in ethnologue.data[i]["languages"]:
                a=[]
                a.append(ethnologue.data[i]["languages"][j]["language_code(ISO639)"])
                for k in  a:
                    if (code == k):
                        print(i)
    ...
    def country_family_languages(country_name="India",family_name="Dravidian"):
        ...
        Examples:
        --------
        >>> ethnologue.country_family_languages('Japan','Japonic')
        ...
        >>> ethnologue.country_family_languages('India','Dravidian')
        ...
        b = []
        for i in ethnologue.data[country_name]['families'][family_name]:
    ...
    def language_to_family(language_name="Tamil"):
        ...
        Examples:
        --------
        >>> ethnologue.language_to_family('Tamil')
        'Dravidian'

        >>> ethnologue.language_to_family('Japanese')
        'Japonic'

        >>> ethnologue.language_to_family('English')
        'Creole'

        """
        a=[]
        for i in ethnologue.data.keys():
            for j,k in ethnologue.data[i]["families"].items():
                a.append(k)
    ...
    def all_families_list():
        ...
        a=[]
        for i in ethnologue.data.keys():
            for j in ethnologue.data[i]['families'].keys():
                a.append(j)
    ...
    def family_to_country(family_name="Dravidian"):
        ...
        Examples:
        --------
        >>> ethnologue.family_to_country('Dravidian')
        Afghanistan
        Bangladesh
        India
        Nepal
        ...
        >>> ethnologue.family_to_country('Japonic')
        Japan
        """
        for i in ethnologue.data.keys():
            a=[]
    ...
    def all_family_languages(family):
            ...
            result = []
            for i in ethnologue.data.keys():
                if family in ethnologue.data[i]['families']:
                    result.append(ethnologue.data[i]['families'][family])
            return result
